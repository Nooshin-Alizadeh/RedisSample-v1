...
### Entity (Model)
- **Location**: `src/Server/RedisSample.Server.Api/Features/{FeatureName}/`
- **File**: `{EntityName}.cs`
- **Requirements**:
...
- **Migration**: 
  - Run: `dotnet ef migrations add {MigrationName} --output-dir Infrastructure/Data/Migrations --verbose` in `RedisSample.Server.Api` project

### DTO
- **Location**: `src/Shared/RedisSample.Shared/Features/{FeatureName}/`
...
**Location**: `src/Client/RedisSample.Client.Core/Components/Pages/{FeatureName}/`

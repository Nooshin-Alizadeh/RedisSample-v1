...
#### Server API Resources (`src/Server/RedisSample.Server.Api/Features/Identity/Resources/`)
...
The `AppDataAnnotationsValidator` (located in `src/Client/RedisSample.Client.Core/Components/AppDataAnnotationsValidator.cs`) extends the validation system to:
...
Here's an actual example from the project (`src/Client/RedisSample.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor`):
...
- Components: `src/Client/RedisSample.Client.Core/Components/AppComponentBase.cs`
- Pages: `src/Client/RedisSample.Client.Core/Components/Pages/AppPageBase.cs`
...
**Base class location**: `src/Server/RedisSample.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`

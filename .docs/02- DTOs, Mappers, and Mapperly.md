...
Welcome to **Stage 2** of the RedisSample project tutorial! In this stage, you'll learn about:
...
```csharp
namespace RedisSample.Shared.Dtos.Categories;
...
**More info**: [Server/Features/Mappers.md](/src/Server/RedisSample.Server.Api/Features/Mappers.md)
...
**Location**: [`src/Server/RedisSample.Server.Api/Features/Categories/CategoriesMapper.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/CategoriesMapper.cs)
...
For reference, here's the entity model: [`Category.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/Category.cs)
...
**Example from [`CategoryController.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/CategoryController.cs):**
...
**Location**: [`AddOrEditCategoryModal.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor.cs)
...
**Location**: [`ProfileSection.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/Settings/ProfileSection.razor.cs)

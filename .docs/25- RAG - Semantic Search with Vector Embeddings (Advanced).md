...
The project supports multiple embedding model providers. You configure them in `appsettings.json` under the `AI` section in the `RedisSample.Server.Api` project.

### 3.1 LocalTextEmbeddingGenerationService (Default)

**Location**: [`src/Server/RedisSample.Server.Api/Program.Services.cs`](/src/Server/RedisSample.Server.Api/Program.Services.cs) (lines 367-372)
...
#### **OpenAI Embeddings**
**Configuration** in [`appsettings.json`](/src/Server/RedisSample.Server.Api/appsettings.json):
```json
"OpenAI": {
...
**File Location**: [`src/Server/RedisSample.Server.Api/Infrastructure/Data/AppDbContext.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Data/AppDbContext.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/Features/Products/Product.cs`](/src/Server/RedisSample.Server.Api/Features/Products/Product.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/Features/Products/ProductConfiguration.cs`](/src/Server/RedisSample.Server.Api/Features/Products/ProductConfiguration.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/Features/Products/ProductEmbeddingService.cs`](/src/Server/RedisSample.Server.Api/Features/Products/ProductEmbeddingService.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/Features/Products/ProductController.cs`](/src/Server/RedisSample.Server.Api/Features/Products/ProductController.cs)

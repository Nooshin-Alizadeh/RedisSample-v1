...
Welcome to Stage 6! In this stage, you will learn about the comprehensive exception handling and error management system built into the RedisSample project.
...
From [`src/Server/RedisSample.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs`](/src/Server/RedisSample.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs):
...
**Location:** [`src/Server/RedisSample.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs)
...
```json
{
  "type": "RedisSample.Shared.Exceptions.TooManyRequestsException",
...
From [`src/Server/RedisSample.Server.Api/Features/Identity/IdentityController.cs`](/src/Server/RedisSample.Server.Api/Features/Identity/IdentityController.cs):
...
From [`src/Client/RedisSample.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs):
...
**Location:** [`src/Client/RedisSample.Client.Core/Components/AppComponentBase.cs`](/src/Client/RedisSample.Client.Core/Components/AppComponentBase.cs)
...
From [`src/Client/RedisSample.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor`](/src/Client/RedisSample.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor):
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/RedisSample.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/RedisSample.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/RedisSample.Client.Core/Components/AppErrorBoundary.razor`](/src/Client/RedisSample.Client.Core/Components/AppErrorBoundary.razor)
...
**Location:** [`src/Server/RedisSample.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs)
...
```json
{
  "type": "RedisSample.Shared.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/RedisSample.Client.Core/Services/ClientExceptionHandlerBase.cs`](/src/Client/RedisSample.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/RedisSample.Client.Web/Services/WebClientExceptionHandler.cs`](/src/Client/RedisSample.Client.Web/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/RedisSample.Client.Maui/Services/MauiExceptionHandler.cs`](/src/Client/RedisSample.Client.Maui/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/RedisSample.Client.Windows/Services/WindowsExceptionHandler.cs`](/src/Client/RedisSample.Client.Windows/Services/WindowsExceptionHandler.cs)

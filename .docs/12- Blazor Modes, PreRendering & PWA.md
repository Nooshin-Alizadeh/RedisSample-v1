...
Welcome to Stage 12 of the RedisSample project tutorial! In this stage, you'll learn about Blazor rendering modes, pre-rendering capabilities, Progressive Web App (PWA) features, and how they all work together in this project.
...
1. **[`/src/Server/RedisSample.Server.Web/Components/App.razor`](/src/Server/RedisSample.Server.Web/Components/App.razor)** - The main entry point for Blazor Server, WebAssembly, Auto and Static SSR
2. **[`/src/Client/RedisSample.Client.Web/wwwroot/index.html`](/src/Client/RedisSample.Client.Web/wwwroot/index.html)** - The entry point for Blazor WebAssembly standalone mode
3. **[`/src/Client/RedisSample.Client.Maui/wwwroot/index.html`](/src/Client/RedisSample.Client.Maui/wwwroot/index.html)** - The entry point for Blazor Hybrid / MAUI
...
<link href="_content/RedisSample.Client.Core/styles/app.css" rel="stylesheet" />
```
...
<script src="_content/RedisSample.Client.Core/scripts/app.js"></script>
...
**File**: [`/src/Client/RedisSample.Client.Web/wwwroot/service-worker.published.js`](/src/Client/RedisSample.Client.Web/wwwroot/service-worker.published.js)
...
self.externalAssets = [
    ...
    { "url": "RedisSample.Server.Web.styles.css" },
    { "url": "RedisSample.Client.Web.bundle.scp.css" }
];
```

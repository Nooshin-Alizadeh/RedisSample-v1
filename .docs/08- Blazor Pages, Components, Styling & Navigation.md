...
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor`](/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor)
...
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)

This file contains the **component logic** - all C# code for the component:

```csharp
using RedisSample.Shared.Dtos.Products;
using RedisSample.Shared.Controllers.Products;

namespace RedisSample.Client.Core.Components.Pages.Products;
...
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.scss`](/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.scss)
...
#### Adding to NavBar
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Layout/NavBar.razor`](/src/Client/RedisSample.Client.Core/Components/Layout/NavBar.razor)
...
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Layout/MainLayout.razor.items.cs`](/src/Client/RedisSample.Client.Core/Components/Layout/MainLayout.razor.items.cs)
...
Some pages need access to native platform features (e.g., device info, native APIs). Instead of placing them in `RedisSample.Client.Core` and using dependency injection or pub-sub patterns, you can create **platform-specific pages** directly in platform projects.

#### Example: AboutPage

The `AboutPage` demonstrates this pattern by existing in multiple platform projects:
- [`/src/Client/RedisSample.Client.Maui/Components/Pages/AboutPage.razor`](/src/Client/RedisSample.Client.Maui/Components/Pages/AboutPage.razor)
- [`/src/Client/RedisSample.Client.Windows/Components/Pages/AboutPage.razor`](/src/Client/RedisSample.Client.Windows/Components/Pages/AboutPage.razor)
- [`/src/Client/RedisSample.Client.Web/Components/Pages/AboutPage.razor`](/src/Client/RedisSample.Client.Web/Components/Pages/AboutPage.razor)
...
**In `RedisSample.Client.Maui.csproj`, `RedisSample.Client.Windows.csproj`, and `RedisSample.Client.Web.csproj`:**
...
<Target Name="BuildCssFiles">
    <Exec Command="../RedisSample.Client.Core/node_modules/.bin/sass Components:Components" />
</Target>
```
...
**Location**: [`/src/Client/RedisSample.Client.Core/Styles/app.scss`](/src/Client/RedisSample.Client.Core/Styles/app.scss)
...
**Location**: [`/src/Client/RedisSample.Client.Core/Styles/abstracts/_bit-css-variables.scss`](/src/Client/RedisSample.Client.Core/Styles/abstracts/_bit-css-variables.scss)
...
**Location**: [`/src/Client/RedisSample.Client.Core/Components/Pages/AppPageBase.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/AppPageBase.cs)

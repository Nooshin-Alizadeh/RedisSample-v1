...
The test project is located at [`src/Tests/RedisSample.Tests.csproj`](/src/Tests/RedisSample.Tests.csproj) and contains:
...
<RunSettings>
    <RunConfiguration>
        <EnvironmentVariables>            
            ...
            <ConnectionStrings__sqlite>Data Source=RedisSampleDb.db;Mode=Memory;Cache=Shared;</ConnectionStrings__sqlite>
        </EnvironmentVariables>
    </RunConfiguration>
</RunSettings>
```
...
```yaml
- name: Run Tests
  run: dotnet test src/Tests/RedisSample.Tests.csproj --configuration Release

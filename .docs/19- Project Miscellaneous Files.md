...
**Location**: [`/RedisSample.sln`](/RedisSample.sln)

**Purpose**: The **full solution file** for Visual Studio that includes ALL projects in the workspace.

**Contains**:
- Server projects (`RedisSample.Server.Web`, `RedisSample.Server.Api`, `RedisSample.Server.Shared`, `RedisSample.Server.AppHost`)
- Client projects (`RedisSample.Client.Core`, `RedisSample.Client.Web`, `RedisSample.Client.Maui`, `RedisSample.Client.Windows`)
- Shared project (`RedisSample.Shared`)
- Tests project (`RedisSample.Tests`)
...
### 2.2 `RedisSample.Web.slnf`

**Location**: [`/RedisSample.Web.slnf`](/RedisSample.Web.slnf)
...
**Projects included**:
- `RedisSample.Server.Web`
- `RedisSample.Server.Api`
- `RedisSample.Server.Shared`
- `RedisSample.Server.AppHost`
- `RedisSample.Client.Core`
- `RedisSample.Client.Web`
- `RedisSample.Shared`
- `RedisSample.Tests`
...
### 2.3 `RedisSample.slnx`

**Location**: [`/RedisSample.slnx`](/RedisSample.slnx)
...
<Using Include="RedisSample.Shared.Dtos" />
<Using Include="RedisSample.Shared.Exceptions" />
<!-- ... and many more -->
```
...
```json
{
    ...
    "dotnet.defaultSolution": "RedisSample.Web.slnf",
...
- **Default Solution**: Uses `RedisSample.Web.slnf` for faster load times
...
- **`build`**: Builds the `RedisSample.Server.Web` project
...
```json
{
    "configurations": [
        {
            "name": "C#: RedisSample.Server.Web Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/RedisSample.Server.Web/RedisSample.Server.Web.csproj"
        },
        {
            "name": "C#: RedisSample.Server.Api Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/RedisSample.Server.Api/RedisSample.Server.Api.csproj"
        },
        {
            "name": ".NET MAUI",
            "type": "maui",
...
- **Custom RedisSample patterns**:
  - `*Resource.designer.cs` (auto-generated from `.resx`)
  - `/src/Client/RedisSample.Client.Core/Scripts/*.js` (generated from TypeScript)
  - `/src/Client/RedisSample.Client.Maui/Platforms/Android/google-services.json` (sensitive Firebase config)

...
✓ Builds entire solution (RedisSample.slnx)
...
2. **Build & Package with Velopack**
   ...
   dotnet vpk pack \
     ...
     -e RedisSample.Client.Windows.exe \  # Main executable
     -r win-x86 \                   # Runtime
...
1. **Setup Android Signing**
   ...
   - Save as RedisSample.keystore in project directory
...
dotnet publish -c Release \
  ...
  -p:AndroidSigningKeyStore="RedisSample.keystore" \
  -p:AndroidSigningKeyAlias=RedisSample \

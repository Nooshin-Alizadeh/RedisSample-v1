...
Welcome to **Stage 13** of the RedisSample project getting started guide! In this stage, we'll explore the **Force Update System** - a critical feature that ensures all users are running compatible versions of your application.
...
**File**: [`src/Client/RedisSample.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs`](/src/Client/RedisSample.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/RedisSample.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs`](/src/Server/RedisSample.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs)
...
**File**: [`src/Server/RedisSample.Server.Api/appsettings.json`](/src/Server/RedisSample.Server.Api/appsettings.json)
...
**File**: [`src/Server/RedisSample.Server.Api/ServerApiSettings.cs`](/src/Server/RedisSample.Server.Api/ServerApiSettings.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs`](/src/Client/RedisSample.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Services/Contracts/IAppUpdateService.cs`](/src/Client/RedisSample.Client.Core/Services/Contracts/IAppUpdateService.cs)
...
**File**: [`src/Client/RedisSample.Client.Web/Infrastructure/Services/WebAppUpdateService.cs`](/src/Client/RedisSample.Client.Web/Infrastructure/Services/WebAppUpdateService.cs)
...
**File**: [`src/Client/RedisSample.Client.Windows/Services/WindowsAppUpdateService.cs`](/src/Client/RedisSample.Client.Windows/Services/WindowsAppUpdateService.cs)
...
**File**: [`src/Client/RedisSample.Client.Maui/Services/MauiAppUpdateService.cs`](/src/Client/RedisSample.Client.Maui/Services/MauiAppUpdateService.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Components/Layout/ForceUpdateSnackBar.razor`](/src/Client/RedisSample.Client.Core/Components/Layout/ForceUpdateSnackBar.razor)
...
**File**: [`src/Client/RedisSample.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs)

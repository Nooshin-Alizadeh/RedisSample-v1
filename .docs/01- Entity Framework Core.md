...
Welcome to the interactive Getting Started guide! This document will walk you through the Entity Framework Core architecture in this RedisSample project.
...
[`/src/Server/RedisSample.Server.Api/Infrastructure/Data/AppDbContext.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Data/AppDbContext.cs)
...
[`/src/Server/RedisSample.Server.Api/Features/`](/src/Server/RedisSample.Server.Api/Features/)
...
**File:** [`/src/Server/RedisSample.Server.Api/Features/Categories/Category.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/Category.cs)

```csharp
using RedisSample.Server.Api.Features.Products;

namespace RedisSample.Server.Api.Features.Categories;
...
**File:** [`/src/Server/RedisSample.Server.Api/Features/Categories/CategoryConfiguration.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/CategoryConfiguration.cs)
...
**File:** [`/src/Server/RedisSample.Server.Api/Program.cs`](/src/Server/RedisSample.Server.Api/Program.cs)
```csharp
...
1. [`/src/Server/RedisSample.Server.Api/Program.cs`](/src/Server/RedisSample.Server.Api/Program.cs)
2. [`/src/Server/RedisSample.Server.Web/Program.cs`](/src/Server/RedisSample.Server.Web/Program.cs)
...
Open a terminal in the `RedisSample.Server.Api` project directory and run:

...
- [`src/Client/RedisSample.Client.Core/appsettings.json`](/src/Client/RedisSample.Client.Core/appsettings.json) - Client-side shared configuration
- [`src/Client/RedisSample.Client.Core/appsettings.Development.json`](/src/Client/RedisSample.Client.Core/appsettings.Development.json) - Development overrides
- [`src/Client/RedisSample.Client.Core/appsettings.Production.json`](/src/Client/RedisSample.Client.Core/appsettings.Production.json) - Production overrides

### Platform-Specific Client Configuration
- **Blazor WebAssembly**: 
  - [`src/Client/RedisSample.Client.Web/appsettings.json`](/src/Client/RedisSample.Client.Web/appsettings.json)
  - [`src/Client/RedisSample.Client.Web/appsettings.Development.json`](/src/Client/RedisSample.Client.Web/appsettings.Development.json)
  - [`src/Client/RedisSample.Client.Web/appsettings.Production.json`](/src/Client/RedisSample.Client.Web/appsettings.Production.json)
- **.NET MAUI**: 
  - [`src/Client/RedisSample.Client.Maui/appsettings.json`](/src/Client/RedisSample.Client.Maui/appsettings.json)
  - [`src/Client/RedisSample.Client.Maui/appsettings.Development.json`](/src/Client/RedisSample.Client.Maui/appsettings.Development.json)
  - [`src/Client/RedisSample.Client.Maui/appsettings.Production.json`](/src/Client/RedisSample.Client.Maui/appsettings.Production.json)
- **Windows**: 
  - [`src/Client/RedisSample.Client.Windows/appsettings.json`](/src/Client/RedisSample.Client.Windows/appsettings.json)
  - [`src/Client/RedisSample.Client.Windows/appsettings.Development.json`](/src/Client/RedisSample.Client.Windows/appsettings.Development.json)
  - [`src/Client/RedisSample.Client.Windows/appsettings.Production.json`](/src/Client/RedisSample.Client.Windows/appsettings.Production.json)

### Server Configuration
- **API Server**: 
  - [`src/Server/RedisSample.Server.Api/appsettings.json`](/src/Server/RedisSample.Server.Api/appsettings.json)
  - [`src/Server/RedisSample.Server.Api/appsettings.Development.json`](/src/Server/RedisSample.Server.Api/appsettings.Development.json)
  - [`src/Server/RedisSample.Server.Api/appsettings.Production.json`](/src/Server/RedisSample.Server.Api/appsettings.Production.json)
- **Web Server**:
  - [`src/Server/RedisSample.Server.Web/appsettings.json`](/src/Server/RedisSample.Server.Web/appsettings.json)
  - [`src/Server/RedisSample.Server.Web/appsettings.Development.json`](/src/Server/RedisSample.Server.Web/appsettings.Development.json)
  - [`src/Server/RedisSample.Server.Web/appsettings.Production.json`](/src/Server/RedisSample.Server.Web/appsettings.Production.json)
- **AppHost**: 
  - [`src/Server/RedisSample.Server.AppHost/appsettings.json`](/src/Server/RedisSample.Server.AppHost/appsettings.json)
  - [`src/Server/RedisSample.Server.AppHost/appsettings.Development.json`](/src/Server/RedisSample.Server.AppHost/appsettings.Development.json)
...
- Server.Web, Client.Web, Client.Windows & Client.Maui: [`src/Client/RedisSample.Client.Core/Infrastructure/Extensions/IConfigurationBuilderExtensions.cs`](/src/Client/RedisSample.Client.Core/Infrastructure/Extensions/IConfigurationBuilderExtensions.cs)
...
In [`src/Client/RedisSample.Client.Core/appsettings.json`](/src/Client/RedisSample.Client.Core/appsettings.json), client-specific settings are defined:

```json
{
    "ServerAddress": "http://localhost:5000/",
    "ServerAddress_Comment": "If you're running RedisSample.Server.Web project, then you can also use relative urls such as / for Blazor Server and WebAssembly",
...
In [`src/Client/RedisSample.Client.Maui/appsettings.json`](/src/Client/RedisSample.Client.Maui/appsettings.json):
...
In [`src/Server/RedisSample.Server.Api/appsettings.json`](/src/Server/RedisSample.Server.Api/appsettings.json), you'll find comprehensive server settings:

```json
{
    "ConnectionStrings": {
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=RedisSampleDb;...",
...
```json
{
    ...
    "ConnectionStrings": {
        "Aspire__Comment": "Running RedisSample.Server.AppHost `overrides` the following connection strings at runtime.",
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=RedisSampleDb;...",
...
**From `src/Server/RedisSample.Server.AppHost/appsettings.Development.json`:**
```json
{
    "Parameters": {
...
**From `src/Client/RedisSample.Client.Core/appsettings.json`:**
```json
{
...
2. Override in platform-specific files:
   - For MAUI: [`src/Client/RedisSample.Client.Maui/appsettings.json`](/src/Client/RedisSample.Client.Maui/appsettings.json)
   - For Web: [`src/Client/RedisSample.Client.Web/appsettings.json`](/src/Client/RedisSample.Client.Web/appsettings.json)
   - For Windows: [`src/Client/RedisSample.Client.Windows/appsettings.json`](/src/Client/RedisSample.Client.Windows/appsettings.json)

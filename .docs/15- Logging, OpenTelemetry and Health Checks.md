...
Welcome to Stage 15! In this stage, you'll learn about the comprehensive logging, observability, and health monitoring infrastructure built into the RedisSample project.
...
This is implemented in [`src/Server/RedisSample.Server.Api/Infrastructure/SignalR/AppHub.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/SignalR/AppHub.cs):
...
When running the project with .NET Aspire (via `RedisSample.Server.AppHost`), the dashboard is automatically available at:
...
From [`src/Server/RedisSample.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs`](/src/Server/RedisSample.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs):
...
From [`src/Server/RedisSample.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs`](/src/Server/RedisSample.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs):
...
The project includes a custom health check for storage in [`src/Server/RedisSample.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs):

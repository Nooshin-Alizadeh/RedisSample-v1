...
**File**: [`src/Server/RedisSample.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`](/src/Server/RedisSample.Server.Api/Infrastructure/Controllers/AppControllerBase.cs)

```csharp
namespace RedisSample.Server.Api.Controllers;
...
3. **Cleaner Code**: Less redissample, more focus on business logic.

### Example from CategoryController

**File**: [`src/Server/RedisSample.Server.Api/Features/Categories/CategoryController.cs`](/src/Server/RedisSample.Server.Api/Features/Categories/CategoryController.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Infrastructure/Services/ODataQuery.cs`](/src/Client/RedisSample.Client.Core/Infrastructure/Services/ODataQuery.cs)
...
**File**: [`src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/RedisSample.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)
...
2. Implement the interface in `RedisSample.Server.Api/Controllers` (server-side)

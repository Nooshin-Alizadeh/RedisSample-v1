...
### Location
[`/src/Client/RedisSample.Client.Core/tsconfig.json`](/src/Client/RedisSample.Client.Core/tsconfig.json)
...
```jsonc
{
    /* Note for Developers:
        ...
        of the MSBuild process defined in the RedisSample.Client.Core.csproj file's `BuildJavaScript` target.
    */
    "compilerOptions": {
        "strict": true,
        "target": "ES2019",
...
### Location
[`/src/Client/RedisSample.Client.Core/package.json`](/src/Client/RedisSample.Client.Core/package.json)
...
### Location
[`/src/Client/RedisSample.Client.Core/RedisSample.Client.Core.csproj`](/src/Client/RedisSample.Client.Core/RedisSample.Client.Core.csproj)
...
**Location:** [`/src/Client/RedisSample.Client.Core/Scripts/App.ts`](/src/Client/RedisSample.Client.Core/Scripts/App.ts)
...
**Location:** [`/src/Client/RedisSample.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs`](/src/Client/RedisSample.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs)

This file defines C# extension methods that call the JavaScript functions in `App.ts`:

```csharp
using System.Reflection;
using RedisSample.Shared.Dtos.PushNotification;
...
Run the following commands in the `RedisSample.Client.Core` directory:

```powershell
cd src/Client/RedisSample.Client.Core
npm install uuid
...
Add this import at the top and new method to the `App` class in [`Scripts/App.ts`](/src/Client/RedisSample.Client.Core/Scripts/App.ts):
...
Add this method to [`Extensions/IJSRuntimeExtensions.cs`](/src/Client/RedisSample.Client.Core/Extensions/IJSRuntimeExtensions.cs):
...
```powershell
cd src/Server/RedisSample.Server.Web
dotnet build
```

# Azure Application Insights - Grafana Dashboard RedisSample

This repository contains a production-ready Grafana Dashboard RedisSample tailored for applications integrated with **Azure Application Insights (Log Analytics Workspace)**. It provides deep visibility into application health, performance metrics, and system exceptions using Kusto Query Language (KQL).
...
Unlike standard dashboards that lump all errors together, this redissample splits exceptions into clear, actionable categories:

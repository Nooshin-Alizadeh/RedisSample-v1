...
using RedisSample.Client.Core.Components;
using RedisSample.Client.Windows.Infrastructure.Services;

using Microsoft.Web.WebView2.Core;
using Microsoft.AspNetCore.Components.Web;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;

namespace RedisSample.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddClientConfigurations(clientEntryAssemblyName: "RedisSample.Client.Windows")

    ...
    protected override async void OnStart()
    {
        try
        {
                ...
                webViewVersion.Major < minimumSupportedWebViewVersion)
            {
                ...
                await App.Current!.Windows[0].Page!.DisplayAlertAsync("RedisSample", localizer[nameof(AppStrings.UpdateWebViewThroughGooglePlay)], localizer[nameof(AppStrings.Ok)]);

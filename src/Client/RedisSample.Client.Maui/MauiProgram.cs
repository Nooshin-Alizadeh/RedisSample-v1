...
using RedisSample.Client.Maui.Infrastructure.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Configuration.AddClientConfigurations(clientEntryAssemblyName: "RedisSample.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientAppMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "RedisSample";
                });
            });

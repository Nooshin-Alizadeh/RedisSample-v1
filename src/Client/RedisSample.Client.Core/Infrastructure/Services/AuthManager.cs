...
namespace RedisSample.Client.Core.Infrastructure.Services;
...
public partial class AuthManager : AuthenticationStateProvider, IAsyncDisposable
{
    ...
    public async Task<bool> TryEnterElevatedAccessMode(CancellationToken cancellationToken)
    {
        ...
        var token = await promptService.Show(localizer[AppStrings.EnterElevatedAccessToken], title: "RedisSample", otpInput: true);

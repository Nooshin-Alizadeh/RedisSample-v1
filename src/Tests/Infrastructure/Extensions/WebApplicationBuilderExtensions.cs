using RedisSample.Tests.Infrastructure.Services;
    ...
    extension(WebApplicationBuilder builder)
    {
        public void AddTestProjectServices()
        {
            ...
            services.AddHangfire((sp, hangfireConfiguration) =>
            {
                ...
                {
                    var keepAliveConnection = new Microsoft.Data.Sqlite.SqliteConnection($"Data Source=RedisSampleJobs-{Guid.NewGuid():N};Mode=Memory;Cache=Shared;");

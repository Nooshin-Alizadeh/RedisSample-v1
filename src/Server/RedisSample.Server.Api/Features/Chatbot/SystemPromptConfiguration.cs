...
- Keep each suggestion concise (under 60 characters)";
    ...
    {
        return @"You are a assistant for the RedisSample app. Below, you will find a markdown document containing information about the app, followed by the user's query.

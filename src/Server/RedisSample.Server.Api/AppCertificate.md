...
- **Industry Standard:** RSA 3072 + SHA-256 is the current "Golden Standard" recommended by NIST for secure applications until at least 2027.
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        ...
        options.TokenValidationParameters = new()
        {
            ...
            ValidAudience = "RedisSample",

            ValidateIssuer = true,
            ValidIssuer = "RedisSample"
        };

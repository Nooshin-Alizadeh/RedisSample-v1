...
namespace RedisSample.Server.Web.Infrastructure.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/RedisSample.Client.Core");
        ...
        // but uses ../../Client/RedisSample.Client.Web:../../Client/RedisSample.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/RedisSample.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/RedisSample.Client.Maui/Components:../../Client/RedisSample.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/RedisSample.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/RedisSample.Client.Windows/Components:../../Client/RedisSample.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/RedisSample.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/RedisSample.Client.Web/Components:../../Client/RedisSample.Client.Web/Components");

    ...
    extension(WebApplication app)
    {
        ...
        public void ConfigureMiddlewares()
        {
            ...
            var blazorApp = app.MapRazorComponents<Components.App>()
                ...
                .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("RedisSample.Client") is true).ToArray());
